...
export function buildDiagnosticsAgentInstructions(connection: DiagnosticsConnection): string {
  return [
    ...
    `- GET ${connection.baseUrl}/chat/operations/events?after=0&limit=500`,
    ...
    'Poll timeline, logs, and Chat operation events independently using nextCursor from each response as its own next after value.',
