...
interface SchemaFormProps {
  ...
  /**
   * Free-form scope phrase used by per-field "ask AI" buttons. Completes
   * the sentence "...field on a Tagma {helpScope} do?". Example values:
   * "`file` trigger plugin", "`exit_code` completion plugin". When omitted
   * the help button is suppressed (e.g. tests/standalone usage).
   */
  helpScope?: string;
}
 ...
 */
export function SchemaForm({ schema, value, onChange, onBrowsePath, helpScope }: SchemaFormProps) {
