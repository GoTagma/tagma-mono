...
export function getEffectiveCompletionType(completion: CompletionConfig | undefined): string {
  return completion?.type ?? DEFAULT_COMPLETION_TYPE;
}

export function isDefaultExitCodeCompletion(completion: CompletionConfig | undefined): boolean {
