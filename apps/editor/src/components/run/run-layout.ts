...
// opening/closing a panel never reflows the flow canvas and invalidates its
// scrollLeft/Top mid-scroll. Same 20rem width and chrome as the live recipe.
export const RUN_HISTORY_INSPECTOR_PANEL_CLASSES =
  'absolute inset-y-0 right-0 z-20 flex h-full w-[calc(100%-1rem)] max-w-[20rem] flex-col border-l border-tagma-border bg-tagma-surface shadow-panel animate-slide-in-right';
