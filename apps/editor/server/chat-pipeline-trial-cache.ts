...
export const CHAT_PIPELINE_TRIAL_CACHE_VERSION = 32 as const;
...
export function buildChatPipelineTrialLiveSmokeReadiness(input: {
  ...
  return {
    ...
    pipelineOutputTaskIds: canonicalTaskIds(input.baseline.pipelineOutputTaskIds),
  };
}
...
export function isChatPipelineTrialLiveSmokeReadiness(
  ...
  if (
    ...
    !isCanonicalTaskIds(candidate.pipelineOutputTaskIds) ||
