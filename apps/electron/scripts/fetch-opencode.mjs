...
function readBundledVersion() {
  ...
  if (typeof v !== 'string' || !v) {
    throw new Error(
      `apps/electron/package.json is missing "tagma.bundledOpencodeVersion" — set it to a concrete opencode-ai version (e.g. "1.4.4").`,
    );
  }
  return v;
}
...
async function main() {
  ...
  // electron-builder copies the selected target directory to
