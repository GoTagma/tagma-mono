...
- **Pin location:** `package.json → tagma.bundledOpencodeVersion` (currently `1.14.41`). Bump that field and re-run a `dist:desktop:*` command to cut a release with a new default.
